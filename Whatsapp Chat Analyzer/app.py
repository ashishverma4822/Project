...
st.set_page_config(
    page_title="BabbleVista Analyzer",
...
st.sidebar.title("BabbleVista Analyzer")
...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        with col2:
            ...
            fig, ax = plt.subplots()
            ax.barh(busy_month.index, busy_month.values, color='lightblue')
            st.pyplot(fig)
        ...
        fig, ax = plt.subplots()
        ax.barh(most_common_df[0], most_common_df[1], color='lightblue')
        plt.xticks(rotation='vertical')
